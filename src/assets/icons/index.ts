...
import { TbWallet, TbTrendingUp, TbHeadphones, TbCards } from "react-icons/tb";
...
import { LuDices, LuTrophy, LuTv, LuTicket, LuSparkles, LuFlame, LuUsers, LuHistory, LuHeart, LuClock, LuCrown, LuCoins, LuGem, LuTent, LuSpade, LuCalendar, LuTarget, LuCircleCheck } from "react-icons/lu";
...
export const HeartIcon = LuHeart;
export const ClockIcon = LuClock;
export const CrownIcon = LuCrown;
export const CoinsIcon = LuCoins;
export const GemIcon = LuGem;
export const CardsIcon = TbCards;
export const TentIcon = LuTent;
export const SpadeIcon = LuSpade;
export const CalendarIcon = LuCalendar;
export const TargetIcon = LuTarget;
export const CheckCircleIcon = LuCircleCheck;
